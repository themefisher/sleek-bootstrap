@@include('header.htm', {
  "title": "Sidebar Static Offcanvas - Sleek Admin Dashboard Template",
...
@@include('sidebar.htm', {
	...
	"sub_parent": "sidebar-variations",
	"active": "sidebar-static-offcanvas"
})
	...
	<div class="col-lg-12">
		<div class="card card-default">
			<div class="card-header  justify-content-between">
				<h2>Sidebar Static Offcanvas</h2>
			</div>

			<div class="card-body">
				<blockquote class="blockquote">
					<p class="mb-0">Add class
						<code>sidebar-static-offcanvas sidebar-collapse</code> to
