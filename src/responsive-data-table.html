@@include('header.htm', {
  "title": "Responsive Data Table - Sleek Admin Dashboard Template",
	...
	"responsive_data_table": "<link href='assets/plugins/data-tables/responsive.datatables.min.css' rel='stylesheet'>",
...
@@include('footer.htm', {
	...
	"responsive_data_table": "<script src='assets/plugins/data-tables/datatables.responsive.min.js'></script>"
})
