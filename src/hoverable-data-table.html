@@include('header.htm', {
  "title": "Hoverable Data Table - Sleek Admin Dashboard Template",
	...
	"data_table": "<link href='assets/plugins/data-tables/datatables.bootstrap4.min.css' rel='stylesheet'>",
...
@@include('sidebar.htm', {
	"parent": "tables",
	"sub_parent": "data-tables",
	"active": "hoverable-data-table"
})
	...
	<div class="col-12">
		<div class="card card-default">
			<div class="card-header card-header-border-bottom d-flex justify-content-between">
				<h2>Hoverable Data Table</h2>

				<a href="https://datatables.net/examples/styling/hover.html" target="_blank" class="btn btn-outline-primary btn-sm text-uppercase">
	...
	<div class="col-lg-12">
		<div class="card card-default">
			<div class="card-header card-header-border-bottom d-flex justify-content-between">
				...
				<a href="https://codepen.io/iamabdus/pen/jOOdRWP" target="_blank" class="btn btn-outline-primary btn-sm text-uppercase">
...
@@include('footer.htm', {
	...
	"data_table": "<script src='assets/plugins/data-tables/jquery.datatables.min.js'></script>",
	"data_table_bootstrap4": "<script src='assets/plugins/data-tables/datatables.bootstrap4.min.js'></script>",
