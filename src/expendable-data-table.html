@@include('header.htm', {
  "title": "Expendable Data Table - Sleek Admin Dashboard Template",
	...
	"expendable_data_table": "<link href='assets/plugins/data-tables/jquery.datatables.min.css' rel='stylesheet'>"
})

@@include('sidebar.htm', {
	"parent": "tables",
	"sub_parent": "data-tables",
	"active": "expendable-data-table"
})
