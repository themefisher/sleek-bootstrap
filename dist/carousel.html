							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">A slideshow component for cycling through elements—images or slides of text—like a carousel. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.4/components/carousel/" target="_blank">
												more details.</a> </p>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">Adding in the previous and next controls. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.4/components/carousel/#with-controls" target="_blank"> more details.</a> </p>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">You can also add the indicators to the carousel, alongside the controls, too. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.4/components/carousel/#with-indicators"
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">Add captions to your slides easily with the .carousel-caption element within any .carousel-item. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.4/components/carousel/#with-captions" target="_blank"> more details.</a> </p>
