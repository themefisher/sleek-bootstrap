							...
							<div class="row">
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">Using the card component, you can extend the default collapse behavior to create an accordion. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.4/components/collapse/#accordion-example" target="_blank">
												more details.</a></p>
