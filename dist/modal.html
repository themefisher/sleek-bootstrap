						...
						<div class="row">
							<div class="col-lg-6 col-xl-4">
								<div class="card card-default">
									...
									<div class="card-body">
										<p class="mb-5">Use Bootstrap’s JavaScript modal plugin to add dialogs to your site. Read bootstrap documentaion for<a href="https://getbootstrap.com/docs/4.4/components/modal/#modal-components" target="_blank"> more details.</a></p>
							...
							<div class="col-lg-6 col-xl-4">
								<div class="card card-default">
									...
									<div class="card-body">
										<p class="mb-5">When modals become too long for the user’s viewport or device, they scroll independent of the page itself. Read bootstrap documentaion for<a href="https://getbootstrap.com/docs/4.4/components/modal/#scrolling-long-content" target="_blank"> more details.</a></p>
							...
							<div class="col-lg-6 col-xl-4">
								<div class="card card-default">
									...
									<div class="card-body">
										<p class="mb-5">Tooltips and popovers can be placed within modals as needed. Read bootstrap documentaion for<a href="https://getbootstrap.com/docs/4.4/components/modal/#scrolling-long-content" target="_blank">
											more details.</a></p>
							...
							<div class="col-lg-6 col-xl-4">
								<div class="card card-default">
									...
									<div class="card-body">
										<p class="mb-5">Utilize the Bootstrap grid system within a modal. Read bootstrap documentaion for<a href="https://getbootstrap.com/docs/4.4/components/modal/#scrolling-long-content" target="_blank">
											more details.</a></p>
							...
							<div class="col-lg-6 col-xl-4">
								<div class="card card-default">
									...
									<div class="card-body">
										<p class="mb-5">You can use form structure in your modal. Read bootstrap documentaion for<a href="https://getbootstrap.com/docs/4.4/components/modal/" target="_blank"> more details. </a></p>
							...
							<div class="col-lg-6 col-xl-4">
								<div class="card card-default">
									...
									<div class="card-body">
										<p class="mb-5">Modals have two optional sizes, available via modifier classes. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.4/components/modal/#optional-sizes" target="_blank">
											more details.</a></p>
